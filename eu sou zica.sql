...
-- ex1
SELECT Orders.order_id, Orders.order_date, CONCAT(Customers.first_name, ' ', Customers.last_name) AS full_name, Customers.email
FROM Orders
...
-- ex3
SELECT CONCAT(Customers.first_name, ' ', Customers.last_name) AS full_name, SUM(Order_Items.quantity * Products.price) AS total_spent
FROM Customers
